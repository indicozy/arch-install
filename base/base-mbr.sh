...
grub-install --target=i386-pc /dev/sdX # TODO replace sdx with your disk name, not the partition
...
echo "username ALL=(ALL) ALL" >> /etc/sudoers.d/ermanno # TODO CHANGE USERNAME
